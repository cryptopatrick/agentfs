...
First off, thank you for considering contributing to agentfs. 
It's people like you that make agentfs great!
...
```bash
git clone https://github.com/cryptopatrick/agentfs.git
cd agentfs
```
...
To run agentfs, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/agentfs/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/agentfs/issues) to report any bugs or request new features.
...
Thank you for contributing to agentfs!
